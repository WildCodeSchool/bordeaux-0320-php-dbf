...
use App\Service\Deletors\ConcessionDeletor;
...
class ConcessionController extends AbstractController
{
    ...
    /**
     * @Route("/delete/{concession}", name="delete_concession", methods={"DELETE"})
     * @return JsonResponse
     */
    public function delete(
        Concession $concession,
        ConcessionDeletor $concessionDeletor
    ): JsonResponse {

        $concessionDeletor->deleteConcession($concession);
