 ...
 */
final class Version20200707135741 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE service_head (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, service_id INT NOT NULL, INDEX IDX_69B04270A76ED395 (user_id), INDEX IDX_69B04270ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE call_transfer (id INT AUTO_INCREMENT NOT NULL, by_whom_id INT NOT NULL, from_whom_id INT NOT NULL, to_whom_id INT NOT NULL, refered_call_id INT NOT NULL, created_at DATETIME NOT NULL, comment_transfer VARCHAR(255) DEFAULT NULL, INDEX IDX_1652C27A60D8982D (by_whom_id), INDEX IDX_1652C27A9D748C23 (from_whom_id), INDEX IDX_1652C27A95B25279 (to_whom_id), INDEX IDX_1652C27ABE5DC693 (refered_call_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, service_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `call` (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, vehicle_id INT NOT NULL, subject_id INT NOT NULL, comment_id INT DEFAULT NULL, service_id INT NOT NULL, recall_period_id INT NOT NULL, recipient_id INT DEFAULT NULL, author_id INT NOT NULL, is_urgent TINYINT(1) NOT NULL, is_process_ended TINYINT(1) DEFAULT NULL, is_appointment_taken TINYINT(1) DEFAULT NULL, created_at DATETIME NOT NULL, recall_date DATE NOT NULL, recall_hour TIME NOT NULL, free_comment VARCHAR(255) DEFAULT NULL, source VARCHAR(255) DEFAULT NULL, internet VARCHAR(255) DEFAULT NULL, is_processed TINYINT(1) DEFAULT NULL, appointment_date DATE DEFAULT NULL, INDEX IDX_CC8E2F3E19EB6921 (client_id), INDEX IDX_CC8E2F3E545317D1 (vehicle_id), INDEX IDX_CC8E2F3E23EDC87 (subject_id), INDEX IDX_CC8E2F3EF8697D13 (comment_id), INDEX IDX_CC8E2F3EED5CA9E6 (service_id), INDEX IDX_CC8E2F3ED31619AD (recall_period_id), INDEX IDX_CC8E2F3EE92F8F78 (recipient_id), INDEX IDX_CC8E2F3EF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, immatriculation VARCHAR(15) NOT NULL, chassis VARCHAR(255) DEFAULT NULL, has_come INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_1B80E48619EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, civility_id INT NOT NULL, name VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, phone2 VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_C744045523D6A298 (civility_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE service_head ADD CONSTRAINT FK_69B04270A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE service_head ADD CONSTRAINT FK_69B04270ED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE service_head DROP FOREIGN KEY FK_69B04270ED5CA9E6');
        ...
        $this->addSql('ALTER TABLE service_head DROP FOREIGN KEY FK_69B04270A76ED395');
        ...
        $this->addSql('DROP TABLE service_head');
